...
<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
    <!-- Mangás Card -->
    <a href="LivrosCRUD/index.php" class="group bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md hover:border-brand-200 transition-all duration-200">
...
<div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mt-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100">
            ...
            <a href="LivrosCRUD/index.php" class="text-xs font-semibold text-brand-600 hover:text-brand-700 transition-colors">Ver todos →</a>
        </div>
...
<div class="mt-6 bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
    ...
    <div class="flex flex-wrap gap-3">
        <a href="LivrosCRUD/create.php" class="inline-flex items-center space-x-2 px-4 py-2.5 bg-brand-600 hover:bg-brand-500 text-white text-sm font-semibold rounded-xl transition-all shadow-sm hover:shadow-brand-600/30 hover:-translate-y-0.5">
